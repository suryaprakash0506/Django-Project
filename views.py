...
def submit(request, course_id):
    if request.method == 'POST':
        ...
        return render(request, 'exam_form.html', {'course_id': course_id})
...
def show_exam_result(request, course_id, submission_id):
    ...
    return render(request, 'exam_result.html', {'submission': submission, 'total_score': total_score, 'passed': passed})
